...
namespace _02_Variables
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine("----Elma Birim Fiyatl: " + applePrice + " TL");
            //Console.WriteLine("----Portakal Birim Fiyatı: " + orangePrice + " TL");
            //Console.WriteLine("----Çilek Birim Fiyatı: " + strawberryPrice + " TL");
            //Console.WriteLine("----Patates Birim Fiyatl: " + potatoPrice + " TL");
            //Console.WriteLine("----Domates Birim Fiyatl: " + tomatoPrice + " TL");
            //Console.WriteLine();
            //Console.WriteLine();
